...
class Category(models.Model):
    name = models.CharField(max_length=255, blank=True, null=True)
    addtime = models.DateTimeField(blank=True, null=True,auto_now_add=True)
    account = models.ForeignKey(Account, models.DO_NOTHING, db_column='account', blank=True, null=True)
...
class Comment(models.Model):
    ...
    addtime = models.DateTimeField(blank=True, null=True,auto_now_add=True)
    repaly = models.CharField(max_length=255, blank=True, null=True)
...
class Ip(models.Model):
    ...
    lastview = models.DateTimeField(blank=True, null=True,auto_now=True)
