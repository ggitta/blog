    ...
    var factory = function (exports) {
        ...
        exports.fn.imagePaste = function() {
            ...
            $('#' + id).on('paste', function (e) {
                ...
                //判断图片类型
                if (items && items[items.length-1].type.indexOf('image') > -1) {

                    var file = items[items.length-1].getAsFile();
                    ...
                    */
                    ...
                    forms.append("editormd-image-file", file, "file_"+Date.parse(new Date())+".png"); // 文件
